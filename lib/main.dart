 ...
 List<String> abbreviationForecast = List.filled(7, '');
  ...
  void fetchLocationDay() async {
    ...
    for (var i = 0; i < 7; i++) {
      ...
      var data = result[0];
///today.add(new Duration(days:i+1)).toString());   this just adding the days to current day date for eg if today is 15/9/2021 so it will only add1 to day porton which is 1 that is 16/9/2021
          ...
          child: temperature == null
              ...
              : Scaffold(
                  appBar: AppBar(
                    ...
                    elevation: 0.0,//This property controls the size of the shadow below the app bar. The value must be non-negative.
                  ),
